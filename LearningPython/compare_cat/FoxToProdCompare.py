...
workbook = openpyxl.load_workbook("C:\\Users\\gaa8664\\Desktop\\Employee Wise Templates Allocation (2)_2.xlsx")
fox_sheet = workbook.get_sheet_by_name("Prod Cat") # Sheet3 Original
prod_cat_sheet = workbook.get_sheet_by_name("Sheet3") # Prod Cat Original
...
def read_excel():
    ...
    for row in range(1,row_num+1):
            if row == 1:
                ...
                empcode_col = col_title_seq['PR_NEWCODE']
                ...
                if foxcode != None or foxcode != '':
                    fox_code_num = col_title_seq['Employee']
                    fox_oldcode_num = col_title_seq['Name']
    ...
    workbook.save("C:\\Users\\gaa8664\\Desktop\\Employee Wise Templates Allocation (2)_3.xlsx")
