...
def initialize(output_file):
    ...
    '''comp_sheet, head_map = create_sheet_with_headers(comparison_workbook, 'comparison', global_vars.FOX_PROD_SALHEADS.keys(),
                        'D://comparison.xlsx')'''
    comp_sheet = create_sheets_as_heads(comparison_workbook, global_vars.FOX_PROD_SALHEADS.keys(), output_file)


def sal_comparison(file_name, sheet, year, month,output_file):
    emp_sal_map = {}
    fox_salary = {}
    count = 0
    ...
    comparison_workbook.save(output_file)
    parseworkbook.process_workbook(output_file)
...
def enter_val_comparision_sheet(head, fox_val, prod_val, empcode, row_count):
    ...
    if sheet_name:
        sheet = comparison_workbook[sheet_name_work.lower()]
...
if __name__ == '__main__':
    ...
    output_file = 'E:\Salary\Feb 2019\\Salary Feb Comp_3.xlsx'
    sheet_name = 'Feb 19'
    # create maps
    ...
    # compare salary
    sal_comparison(file_name, sheet_name, '2019', '02', output_file)
